...
describe('diary architecture', () => {
  ...
  it('keeps diary pages full-width and library cards visibly notebook-shaped', () => {
    ...
    expect(reader).toContain('diary-book-frame')
    expect(reader).toContain('w-full')
    expect(today).toContain('diary-book-frame')
    expect(today).toContain('w-full')
  ...
  it('keeps the today and reader pages inside the premium leather-book shell', () => {
    const premiumCss = read('src/renderer/src/modules/diary/diary-premium.css')
    const reader = read('src/renderer/src/modules/diary/components/DiaryReader.tsx')
    const today = read('src/renderer/src/modules/diary/components/DiaryToday.tsx')

    expect(reader).toContain("import '../diary-premium.css'")
    expect(today).toContain("import '../diary-premium.css'")
    expect(reader).toContain('diary-premium-book')
    expect(today).toContain('diary-premium-book')
    expect(reader).toContain('diary-premium-paper')
    expect(today).toContain('diary-premium-paper')
    expect(reader).toContain('diary-side-tab')
    expect(today).toContain('diary-side-tab')
    expect(reader).toContain('diary-bookmark-ribbon')
    expect(today).toContain('diary-bookmark-ribbon')
    expect(premiumCss).toContain('.diary-premium-book')
