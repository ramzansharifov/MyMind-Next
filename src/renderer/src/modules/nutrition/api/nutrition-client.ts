...
export const nutritionClient = {
  ...
  createLogEntry: (input: CreateNutritionLogEntryInput) => window.api.nutrition.createLogEntry(input),
  updateLogEntry: (input: UpdateNutritionLogEntryInput) => window.api.nutrition.updateLogEntry(input),
  deleteLogEntry: (input: DeleteNutritionLogEntryInput) => window.api.nutrition.deleteLogEntry(input),
