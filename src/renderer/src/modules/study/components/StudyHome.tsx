      ...
      <div className="mx-auto w-full max-w-6xl">
        <header className="flex items-start justify-between gap-6 max-[760px]:flex-col">
          <div className="flex min-w-0 items-start gap-4">
            <div className="flex size-12 shrink-0 items-center justify-center rounded-2xl bg-violet-500/12 text-violet-300 ring-1 ring-inset ring-violet-500/15">
              <BookOpen
                aria-hidden="true"
                className="size-6"
              />
          ...
          <div className="flex shrink-0 items-center gap-2 max-[520px]:w-full max-[520px]:flex-col">
            <button
              type="button"
              disabled={isLoading}
              className="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-[var(--app-border)] px-3.5 text-sm font-medium text-[var(--app-text)] outline-none transition-colors hover:border-violet-500/30 hover:bg-white/[0.04] focus-visible:ring-2 focus-visible:ring-violet-500/35 disabled:opacity-40 max-[520px]:w-full"
            ...
            <button
              type="button"
              disabled={isLoading}
              className="inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-violet-500 px-3.5 text-sm font-medium text-white outline-none transition-colors hover:bg-violet-400 focus-visible:ring-2 focus-visible:ring-violet-300/50 disabled:opacity-40 max-[520px]:w-full"
...
function StudyStatCard({
  ...
  return (
    <div className="flex min-w-0 items-center gap-3 rounded-xl border border-[var(--app-border)] bg-[var(--app-surface)] p-4">
      ...
      <div className="min-w-0">
        <p className="text-2xl font-semibold tabular-nums text-[var(--app-text)]">
          {value}
        </p>
...
function StudyNodeCard({
  ...
  return (
    <button
      type="button"
      className="group flex min-w-0 items-center gap-3 rounded-xl border border-[var(--app-border)] bg-[var(--app-surface)] p-4 text-left outline-none transition-colors hover:border-violet-500/30 hover:bg-[var(--app-surface-raised)] focus-visible:ring-2 focus-visible:ring-violet-500/35"
      onClick={() => {
        onOpen(node.id)
      }}
    >
