...
export function createCalendarRepository(runtime: RepositoryRuntime): CalendarRepository {
  ...
  function calculateCalendarElapsed(
  ...
  function listCalendarOccurrences(input: CalendarRangeInput): CalendarOccurrenceRecord[] {
  ...
  function createCalendarEvent(input: CalendarCreateEventInput): CalendarEventRecord {
    const id = randomUUID()
    const now = runtime.now()
  ...
  function updateCalendarEvent(input: CalendarUpdateEventInput): CalendarEventRecord {
  ...
  function deleteCalendarEvent(id: string): boolean {
  ...
  function setCalendarOccurrenceNote(
  ...
  function setCalendarOccurrenceHidden(
  ...
  function listCalendarReminderTriggers(input: CalendarRangeInput): CalendarReminderRecord[] {
  ...
  function listDueCalendarReminders(sinceMs: number, nowMs: number): CalendarReminderRecord[] {
  ...
  function markCalendarReminderDelivered(reminder: CalendarReminderRecord): boolean {
    try {
      getSqlite()
        .prepare(
  ...
  function listUnreadCalendarReminders(): CalendarUnreadReminderRecord[] {
  ...
  function acknowledgeCalendarReminder(input: CalendarAcknowledgeReminderInput): boolean {
    return (
      getSqlite()
        .prepare(
...
export interface CalendarRepository {
  ...
  listCalendarOccurrences(input: CalendarRangeInput): CalendarOccurrenceRecord[]
  createCalendarEvent(input: CalendarCreateEventInput): CalendarEventRecord
  updateCalendarEvent(input: CalendarUpdateEventInput): CalendarEventRecord
  deleteCalendarEvent(id: string): boolean
  setCalendarOccurrenceNote(input: CalendarSetOccurrenceNoteInput): CalendarOccurrenceRecord | null
  setCalendarOccurrenceHidden(
    input: CalendarSetOccurrenceHiddenInput
  ): CalendarOccurrenceRecord | null
  listCalendarReminderTriggers(input: CalendarRangeInput): CalendarReminderRecord[]
  listDueCalendarReminders(sinceMs: number, nowMs: number): CalendarReminderRecord[]
  markCalendarReminderDelivered(reminder: CalendarReminderRecord): boolean
  listUnreadCalendarReminders(): CalendarUnreadReminderRecord[]
  acknowledgeCalendarReminder(input: CalendarAcknowledgeReminderInput): boolean
}
