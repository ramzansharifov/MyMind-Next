...
export function createTasksRepository(runtime: RepositoryRuntime): TasksRepository {
...
FROM tasks`
  ...
  function listTasksOverview(): TasksOverview {
  ...
  function createTaskGroup(input: CreateTaskGroupInput): TaskGroupRecord {
  ...
  function updateTaskGroup(input: UpdateTaskGroupInput): TaskGroupRecord {
  ...
  function deleteTaskGroup(input: DeleteTaskGroupInput): boolean {
    requireGroup(input.id)
    const result = getSqlite().prepare('DELETE FROM task_groups WHERE id = ?').run(input.id)
    return result.changes > 0
  }

  function createTask(input: CreateTaskInput): TaskRecord {
  ...
  function updateTask(input: UpdateTaskInput): TaskRecord {
  ...
  function deleteTask(input: DeleteTaskInput): boolean {
...
export interface TasksRepository {
  listTasksOverview(): TasksOverview
  createTaskGroup(input: CreateTaskGroupInput): TaskGroupRecord
  updateTaskGroup(input: UpdateTaskGroupInput): TaskGroupRecord
  deleteTaskGroup(input: DeleteTaskGroupInput): boolean
