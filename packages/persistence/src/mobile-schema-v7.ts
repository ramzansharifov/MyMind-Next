// Additive migration for native Finance persistence. Previous schema versions remain immutable.
export const mobileSchemaV7: readonly string[] = [
  ...
  `CREATE INDEX \`finance_exchange_rates_base_idx\` ON \`finance_exchange_rates\` (\`base_currency_code\`);`,
  `CREATE UNIQUE INDEX \`finance_exchange_rates_currency_base_unique\` ON \`finance_exchange_rates\` (\`currency_code\`, \`base_currency_code\`);`,
  ...
  `CREATE INDEX \`finance_accounts_currency_idx\` ON \`finance_accounts\` (\`currency_code\`);`,
  ...
  `CREATE INDEX \`finance_tags_type_idx\` ON \`finance_tags\` (\`type\`);`,
  `CREATE INDEX \`finance_tags_name_idx\` ON \`finance_tags\` (\`name\`);`,
  ...
  `CREATE INDEX \`finance_templates_type_idx\` ON \`finance_transaction_templates\` (\`type\`);`,
  `CREATE INDEX \`finance_templates_source_account_idx\` ON \`finance_transaction_templates\` (\`source_account_id\`);`,
  `CREATE INDEX \`finance_templates_destination_account_idx\` ON \`finance_transaction_templates\` (\`destination_account_id\`);`,
  `CREATE INDEX \`finance_templates_tag_idx\` ON \`finance_transaction_templates\` (\`tag_id\`);`,
  ...
  `CREATE INDEX \`finance_transactions_tag_date_idx\` ON \`finance_transactions\` (\`tag_id\`, \`occurred_at\`);`,
  `CREATE INDEX \`finance_transactions_template_date_idx\` ON \`finance_transactions\` (\`template_id\`, \`occurred_at\`);`,
  ...
  `CREATE INDEX \`finance_entries_account_transaction_idx\` ON \`finance_transaction_entries\` (\`account_id\`, \`transaction_id\`);`,
  `CREATE INDEX \`finance_entries_transaction_idx\` ON \`finance_transaction_entries\` (\`transaction_id\`);`,
  ...
  `CREATE INDEX \`finance_limits_state_idx\` ON \`finance_limits\` (\`state\`);`,
  `CREATE INDEX \`finance_limits_account_state_idx\` ON \`finance_limits\` (\`account_id\`, \`state\`);`,
  `CREATE INDEX \`finance_limits_tag_state_idx\` ON \`finance_limits\` (\`tag_id\`, \`state\`);`,
