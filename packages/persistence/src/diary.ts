...
export function createDiaryRepository(runtime: RepositoryRuntime): DiaryRepository {
  ...
  function touchDiary(diaryId: string, at = runtime.now()): void {
  ...
  function listDiaryOverview(): DiaryOverview {
    ensureDefaultDiary()
  ...
  function createDiary(input: CreateDiaryInput): DiarySummary {
    const id = randomUUID()
    const now = runtime.now()
    getSqlite()
      .prepare(
  ...
  function updateDiary(input: UpdateDiaryInput): DiarySummary {
  ...
  function updateDiaryAppearance(input: UpdateDiaryAppearanceInput): DiarySummary {
    requireDiary(input.id)
    const now = runtime.now()
    getSqlite()
      .prepare(
  ...
  function deleteDiary(input: DeleteDiaryInput): boolean {
    requireDiary(input.id)
  ...
  function getDiaryDay(input: GetDiaryDayInput): DiaryDay | null {
  ...
  function listDiaryDays(input: ListDiaryDaysInput): DiaryDaySummary[] {
    requireDiary(input.diaryId)
  ...
  function setDiaryMood(input: SetDiaryMoodInput): DiaryDay | null {
  ...
  function createDiaryEntry(input: CreateDiaryEntryInput): DiaryEntry {
    const sqlite = getSqlite()
    return sqlite.transaction(() => {
  ...
  function updateDiaryEntry(input: UpdateDiaryEntryInput): DiaryEntry {
    const sqlite = getSqlite()
    return sqlite.transaction(() => {
  ...
  function deleteDiaryEntry(input: DeleteDiaryEntryInput): boolean {
    const sqlite = getSqlite()
    return sqlite.transaction(() => {
      const existing = sqlite
        .prepare(
  ...
  function getDiaryReport(input: GetDiaryReportInput): DiaryReport {
...
export interface DiaryRepository {
  listDiaryOverview(): DiaryOverview
  createDiary(input: CreateDiaryInput): DiarySummary
  updateDiary(input: UpdateDiaryInput): DiarySummary
  updateDiaryAppearance(input: UpdateDiaryAppearanceInput): DiarySummary
  deleteDiary(input: DeleteDiaryInput): boolean
  getDiaryDay(input: GetDiaryDayInput): DiaryDay | null
  listDiaryDays(input: ListDiaryDaysInput): DiaryDaySummary[]
  setDiaryMood(input: SetDiaryMoodInput): DiaryDay | null
  createDiaryEntry(input: CreateDiaryEntryInput): DiaryEntry
  updateDiaryEntry(input: UpdateDiaryEntryInput): DiaryEntry
  deleteDiaryEntry(input: DeleteDiaryEntryInput): boolean
  getDiaryReport(input: GetDiaryReportInput): DiaryReport
}
