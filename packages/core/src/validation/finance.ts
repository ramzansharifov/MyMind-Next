...
export const updateFinanceAccountInputSchema = z
  ...
  .strict()
export const deleteFinanceAccountInputSchema = z.object({ id: financeSafeIdSchema })
export const clearFinanceAccountHistoryInputSchema = z.object({
  ...
  confirmation: z.literal('ОЧИСТИТЬ', { error: 'Для подтверждения введите «ОЧИСТИТЬ»' })
})

export const createFinanceTagInputSchema = z
  .object({ name: financeNameSchema, type: financeTagTypeSchema, icon: financeIconNameSchema })
  .strict()
export const updateFinanceTagInputSchema = z
  ...
  .strict()
export const deleteFinanceTagInputSchema = z.object({ id: financeSafeIdSchema })
...
export const deleteFinanceTransactionInputSchema = z.object({ id: financeSafeIdSchema })
...
export const deleteFinanceLimitInputSchema = z.object({ id: financeSafeIdSchema })
...
export const deleteFinanceTemplateInputSchema = z.object({ id: financeSafeIdSchema })
